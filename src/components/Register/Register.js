           ...
           <div class="measure">
             <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
               ...
               <div class="mt3">
                 ...
                 <input class="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-60" type="text" name="name"  id="name" />
               </div>
               <div class="mt3">
                 <label class="db fw6 lh-copy f6" htmlFor="email-address">Email</label>
                 <input class="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-60" type="email" name="email-address"  id="email-address" />
               </div>
               <div class="mv3">
                 <label class="db fw6 lh-copy f6" htmlFor="password">Password</label>
                 <input class="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-60" type="password" name="password"  id="password" />
               </div>
             </fieldset>
             <div class="">
